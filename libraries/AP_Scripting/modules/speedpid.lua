...
SpeedPID.SCRIPT_VERSION = "4.6.0-005"
...
gcs:send_text(SpeedPID.MAV_SEVERITY.INFO, string.format("%s %s module loaded", SpeedPID.SCRIPT_NAME, SpeedPID.SCRIPT_VERSION) )
