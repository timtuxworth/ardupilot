...
void Plane::ahrs_update()
{
    ...
    // tracking if it's following the same vehicle (eg plane_follow.lua,
    // which drives off this same AP_Follow singleton); pushed here (rather
    // than AP_Mount reaching into AP_Follow directly) to avoid a library-
    // to-library dependency - see PR #34237 review discussion
